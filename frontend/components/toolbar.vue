<template>
  <v-app-bar color="blue-grey" dark fixed app clipped-right>
    <v-toolbar-title>
      <v-btn v-if="logged_user" :to="{name: 'timeline'}" text dark ripple class="ma-0 ml-5">Home</v-btn>
      <v-btn v-else :to="{name: 'index'}" text dark ripple class="ma-0 ml-5">Home</v-btn>
    </v-toolbar-title>
    <v-spacer />
